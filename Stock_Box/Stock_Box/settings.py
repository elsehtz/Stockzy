"""
Django settings for Stock_Box project.
...
SECRET_KEY = '6aoepp(-11fc%m5#c8!t2uim^l!1jjs3*7=(=621r*a@xot#i6'
...
WSGI_APPLICATION = 'Stock_Box.wsgi.application'
